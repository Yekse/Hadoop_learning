...
public class child_parent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] otherArgs = new String[]{"C:\\Users\\HP\\Desktop\\mapreduce\\input1",
                "C:\\Users\\HP\\Desktop\\mapreduce\\output1"};

        if (otherArgs.length != 2) {
            System.err.println("Usage: findParent <in> <out>");
            System.exit(2);
        }

        Job job = Job.getInstance(conf, "findParent ");
