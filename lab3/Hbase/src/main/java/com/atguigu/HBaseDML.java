...
public class HBaseDML {
    ...
    public static void deleteColumn(String nameSpace, String tableName,
                                    String rowKey, String family, String column)
            throws IOException {
        // 1.获取 table
...
// delete.addFamily(Bytes.toBytes(family));
     ...
     * @param tableName 表格名称
     */
    public static int countRows(String namespace, String tableName)
            throws IOException {
 ...
 /*       putCell("", "students", "1001","info", "name", "ZhangSan");
        putCell("", "students", "1001","info", "sex", "male");
        putCell("", "students", "1001","info", "age", "19");
        putCell("", "students", "1002","info", "name", "LiSi");
        putCell("", "students", "1002","info", "sex", "male");
        putCell("", "students", "1002","info", "age", "20");
*/
/*
        putCell("", "students", "1003","info", "name", "MeiYangyang");
        putCell("", "students", "1003","info", "sex", "female");
        putCell("", "students", "1003","info", "age", "6");
  */
 //      scanRows("","students","1001","1004");


 //      deleteColumn("", "students", "1001", "info", "sex");
        int a = countRows("","students");
